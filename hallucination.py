...
"""
    ...
    try:
        ...
        output_filename = "hallucination_results.txt"
...
def evaluate_llm(input, context, output):
    ...
    hallucination_metric = HallucinationMetric(model=gemma2_2b, threshold=0.5, include_reason=True)
    hallucination_metric.measure(hallucination_test_case)
    
    
    return hallucination_metric.score, hallucination_metric.reason
